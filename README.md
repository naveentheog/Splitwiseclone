> **Note:** This repository is based on [SplitPro](https://github.com/oss-apps/split-pro), an open source Splitwise alternative, used under the MIT Licence (Copyright (c) 2024 OSS Apps). See [ATTRIBUTION.md](ATTRIBUTION.md).
